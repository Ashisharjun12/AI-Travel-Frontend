...
const OptionCard = ({option, selectedOption}) => {
  return (
    <View style={[{padding:25, flexDirection:'row', justifyContent:'space-between', alignItems:'center', backgroundColor:'#f2f2f2', borderRadius:15},selectedOption?.id==option?.id && {borderWidth:3}]}>
      <View>
